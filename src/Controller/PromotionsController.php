...
class PromotionsController extends AppController
{
    ...
    public function view($id = null)
    {
        $promotion = $this->Promotions->get($id, [
            'contain' => ['Annees', 'Niveaux', 'Series', 'Coefficients', 'Groupes', 'InscriptionFrais', 'Inscriptions', 'Tests']
        ]);
    ...
    public function add()
    {
        ...
        $annees = $this->Promotions->Annees->find('list', ['limit' => 200]);
        $niveaux = $this->Promotions->Niveaux->find('list', ['limit' => 200]);
        $series = $this->Promotions->Series->find('list', ['limit' => 200]);
        $this->set(compact('promotion', 'annees', 'niveaux', 'series'));
    }
