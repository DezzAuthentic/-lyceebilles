...
class TestsController extends AppController
{
    ...
    public function view($id = null)
    {
        $test = $this->Tests->get($id, [
            'contain' => ['Matieres', 'Promotions', 'TestNotes']
        ]);
    ...
    public function add()
    {
        ...
        $matieres = $this->Tests->Matieres->find('list', ['limit' => 200]);
        $promotions = $this->Tests->Promotions->find('list', ['limit' => 200]);
        $this->set(compact('test', 'matieres', 'promotions'));
    }
