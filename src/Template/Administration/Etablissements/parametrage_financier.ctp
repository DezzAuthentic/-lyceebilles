...
<ul class="nav nav-tabs">
    <li id="types_tmenu" class="active tmenu"><a href="#">Types de frais</a></li>
    <li id="mois_tmenu" class="tmenu"><a href="#">Mois</a></li>
    <li id="frais_tmenu" class="tmenu"><a href="#">Frais</a></li>
</ul>
        ...
        <table id="types_table" class="table datatable hover" >
            <thead>
                <tr>
                    ...
                    <th title="Obligatoire">Sélection</th>
                    <th class="actions" >   
                    </th>
            ...
            <?php $i=0; foreach($types as $type): ?>
                <tr>
                    ...
                    <td><?php if($type->selection==0) echo "Tous"; elseif($type->selection==1) echo "Un seul"; elseif($type->selection==1) echo "Multiple";?></td>
                    <td class="actions">
                        <span class="icone glyphicon glyphicon-pencil editType hover" data-toggle="modal"
                        data-target="#editTypeModal" >
                            <input type="hidden" value="<?=$type->id.'*'.$type->nom.'*'.$type->recurrence.'*'.$type->obligatoire?>">
                        </span>
...
Onglet des frais
*********************************************************************************-->
<div id="frais_tab" class="row tab">
    <section class="row">
        <div class="col-xs-12">
            ...
            $i=0; foreach($frais as $frai):
                ...
                if($i==0){
                    ...
                    echo '
                    <div class="col-xs-12 panel-heading"><span class="soustitre">'.$frai->niveaux->nom.$serie.'</span></div>
...
<script>
    ...
    *******************************************************/
    ...
    $(".editType").click(function() {
        ...
        $("#editTypeOrdre").val(data[2]);
        $("#editTypeOrdre").val(data[3]);
    });
