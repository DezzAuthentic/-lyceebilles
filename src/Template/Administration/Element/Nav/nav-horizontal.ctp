<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <div class="navbar-header col-md-3 col-sm-4">
            ...
            <a class="icone pull-left" href="/administration/dashboard/" >
            ...
            <a class="navbar-brand" href="<?=$this->Url->Build(["controller"=>'Dashboard','action'=>'index'])?>"><?=$etablissement->nom?></a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <a class="btn btn-default navbar-btn navbar-right margin-g-5" href="<?=$this->Url->Build(['prefix'=>false,"controller"=>"Users","action"=>"deconnexion"])?>">Déconnexion</a>
            <ul class="nav navbar-nav navbar-right">
                <?php if($etablissement->annee):?>
