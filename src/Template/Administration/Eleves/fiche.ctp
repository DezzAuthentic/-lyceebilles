<div class="titre">
    ...
    <a href="/administration/eleves/modifier/<?=$eleve->id?>" class="pull-right btn btn-sm btn-default">Modifier</a>
</div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-5" for="adresse">Adresse:</label>
                        <div class="col-sm-7">
