        ...
        <div class="col-xs-12">
            <div class="panel panel-danger">
                <div class="panel-body panel-stats" >
                    <span class=""><?=$en_attente?> élève(s) inscrit(s) sont en attente d'affectation.</span>
                    <a class="pull-right btn btn-danger btn-sm" href="<?=$this->Url->Build(['controller'=>"Promotions",'action'=>'index'])?>">Gérer les affectations</a>
                </div>
            </div>
        </div>
    <?php endif ?>
