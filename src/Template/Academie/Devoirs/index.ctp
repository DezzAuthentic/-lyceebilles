<div class="titre">
    ...
    <a class="btn btn-sm btn-default pull-right" href="/academie/devoirs/classe/">Tous les devoirs</a>
</div>
    ...
    <div class="col-xs-12">
        ...
        $i=0; foreach($groupes as $groupe):
            ...
            <div class="col-xs-12 col-sm-4 col-md-3">
                <a class="btn btn-block btn-default btn-sm" href="/academie/devoirs/classe/'.$groupe->id.'">
                    <span class="h5">
