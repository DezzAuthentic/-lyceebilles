<div class="titre">
    ...
    <a href="/academie/tuteurs/modifier/<?=$tuteur->id?>" class="pull-right btn btn-sm btn-default">Modifier</a>
</div>
            ...
            <table id="seances_table" class="table datatable hover compact" >
                ...
                <?php $i=1; foreach($tuteur->eleves as $elef): ?>
                    <tr>
                        ...
                        <td><?=$elef->prenom?></td>
                        <td class="actions">
                            <?= $this->Html->link("<span class='glyphicon glyphicon-eye-open icone'></span> Fiche de l'élève",'/academie/eleves/fiche/'.$elef->id,['escape'=>false,'class' => 'btn btn-xs btn-default'])?>
                        </td>
                    </tr>
                <?php $i++; endforeach;?>
                </tbody>
