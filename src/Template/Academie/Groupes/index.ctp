<div class="titre">
    ...
    <a href="<?=$this->Url->build(['controller'=>'Promotions','action'=>'index'])?>" class="btn btn-default pull-right btn-sm" >
        <span class="glyphicon glyphicon-log-in pr1"></span> Gestion des promotions
    </a>
    <a href="<?=$this->Url->build(['controller'=>'Promotions','action'=>'transfert'])?>" class="btn btn-default pull-right btn-sm mr1" >
        <span class="glyphicon glyphicon-resize-full pr1"></span> Transfert d'élève
    </a>
</div>
    ...
    <div class="col-xs-12">
        ...
        $i=0; foreach($groupes as $groupe):
            ...
            <div class="col-xs-12 col-sm-4 col-md-3">
                <a class="btn btn-block btn-default btn-sm" href="/academie/groupes/gestion/'.$groupe->id.'">
                    <span class="h5">
