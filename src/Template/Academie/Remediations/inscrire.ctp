        ...
        <div class="col-xs-12 col-md-6">
            <div class="panel panel-default bg-gris">
                <div class="panel-body">
                    ...
                    <select name="inscription_id" id="eleve" class="form-control select2">
                        <?php foreach($inscriptions as $inscription): ?>
                            <option value="<?=$inscription->id?>"><?=$inscription->elef->prenom?> <?=$inscription->elef->nom?> - <?=$inscription->elef->matricule?> </option>
                        <?php endforeach;?>
                    </select>
                </div>
            </div>
