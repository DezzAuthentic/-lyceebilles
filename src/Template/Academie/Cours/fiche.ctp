...
<div class="titre">
    ...
    <a class="btn btn-sm btn-default" href="/academie/groupes/fiche/<?=$cours->groupe->id?>"><?=$cours->groupe->nom?></a>
    <a class="btn btn-sm btn-default" href="/academie/professeurs/fiche/<?=$cours->professeur->id?>">Pr. <?=$cours->professeur->nom?> <?=$cours->professeur->prenom?></a>
    
    <a class="btn btn-sm btn-primary pull-right" href="<?=$this->Url->Build(['controller'=>'Cours',"action"=>"cahier-de-texte",$cours->id])?>" >Cahier de texte</a>
</div>
