                    ...
                    <tr>
                        ...
                        <td class="">
                            <?php foreach($periodes as $periode):?>
                                <?=$this->Html->link('<i class="glyphicon glyphicon-eye-open icone"></i>'.$periode->nom,['action'=>"classe", $groupe->id, $periode->id,$affectation->id],['escape'=>false,'class' => 'btn btn-xs btn-default'])?>
                            <?php endforeach;?>
                        </td>
                    </tr>
                <?php $i++; endforeach;?>
            ...
            content: [
                ...
                },
                {
                    columns: [
                        {
                            width: 150,
                            text: [{text:'Classe: ',bold:true},'<?= $groupe->nom?>'],
                            fontSize:10,
                            margin: [0,2]
                        },
                        {
