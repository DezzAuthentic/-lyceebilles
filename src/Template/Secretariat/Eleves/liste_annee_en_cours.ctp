...
<div class="titre">
    <span>Liste année en cours des élèves</span>
</div>
    ...
    <div class="col-xs-12">
        <table id="inscriptions_table" class="table datatable hover compact" >
            ...
            <?php $i=0; foreach($eleves as $eleve): 
                if(sizeof($eleve->inscriptions) > 0): ?>
                <tr>
                    <td><?=$eleve->nom?></td>
                    <td><?=$eleve->prenom?></td>
                    <td><?=$eleve->matricule?></td>
                    <td><?php if($eleve->inscriptions[0]->affectations) echo $eleve->inscriptions[0]->affectations[0]->groupe->nom; ?>
                    </td>
                    <td class="actions">
