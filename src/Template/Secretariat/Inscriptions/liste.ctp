<div class="titre">
    ...
    <a id="ajout_btn" href="/secretariat/inscriptions/nouvelle" class="btn btn-default btn-sm pull-right" >
        ...
        <table id="inscriptions_table" class="table datatable hover compact" >
            ...
            <?php $i=0; foreach($inscriptions as $inscription): ?>
                <tr>
                    ...
                    <td class="actions">
                        <?php //$this->Html->link('Facturation',['controller'=>'Factures','action'=>"parEleveMois",$inscription->id],['class' => 'btn btn-xs btn-warning'])?>
