    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-6 col-md-4">
            <div class="panel panel-default panel_frais" id="panel_facultatives">
                <div class="text-center panel-heading"><span class="soustitre2">Autres frais</span></div>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each( frais, function( key, frai ) {
                    ...
                    else if(frai.type.nom=="Scolarité"){
                    ...
                    //if(frai.type.recurrence==1 && frai.type.obligatoire==0){
                        ...
                        if(frai.type.id!=type_id){
                            ligne = "<tr><td>"+frai.type.nom+"</td>"+
                                "<input type='hidden' name='facultatives["+i+"][recurrence]' value='"+frai.type.recurrence+"' >"+
                                "<td width='50%' class='td-right'><select name='facultatives["+i+"][id]' class='form-control select_facultative' id='facultative_"+frai.type.id+"' name='"+frai.type.nom+"'>";
                            if(frai.type.obligatoire==0) ligne +="<option value=false> -- Non-inscrit -- </option>";
        ...
        $.ajax({
            ...
            //success: function(data) {
                ...
                reduction_msg += " Souhaitez-vous appliquer une réduction?</div>"+
                    ...
                    "<div class='col-sm-3 col-xs-4 col-md-2'><input id='reduction_montant' min='0' max='100' type='number' name='reduction' class='form-control'></div>"+
