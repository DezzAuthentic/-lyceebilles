<div class="titre">
    ...
    <a class="btn btn-warning btn-sm pull-right" href='/finance/factures/par-eleve-mois/<?=$inscription->id?>' >
        <span class="glyphicon glyphicon-credit-card"></span> Factures Tuteur
    </a> 
</div>
...
<div class="modal fade" id="facturesMoisModal" tabindex="-1" role="dialog" aria-labelledby="facturesMoisModalLabel">
    <div class="modal-dialog" role="document">
        <form action="<?= $this->Url->Build(['controller' => 'Reglements', 'action' => 'mois']) ?>" method="post">
            ...
            <input type="hidden" name="parrainage" value="1" >
