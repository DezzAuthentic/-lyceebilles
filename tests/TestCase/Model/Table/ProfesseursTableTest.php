...
class ProfesseursTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('Professeurs') ? [] : ['className' => ProfesseursTable::class];
        $this->Professeurs = TableRegistry::getTableLocator()->get('Professeurs', $config);
    }
