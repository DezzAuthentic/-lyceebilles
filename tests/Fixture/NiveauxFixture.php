...
class NiveauxFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_niveaux_etablissements1_idx' => ['type' => 'index', 'columns' => ['etablissement_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_niveaux_etablissements1' => ['type' => 'foreign', 'columns' => ['etablissement_id'], 'references' => ['etablissements', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
