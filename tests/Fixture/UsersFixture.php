...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'profil' => ['type' => 'string', 'length' => 15, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'creatime' => ['type' => 'timestamp', 'length' => null, 'null' => true, 'default' => 'CURRENT_TIMESTAMP', 'comment' => '', 'precision' => null],
        ...
        '_constraints' => [
            ...
            'creatime_UNIQUE' => ['type' => 'unique', 'columns' => ['creatime'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
