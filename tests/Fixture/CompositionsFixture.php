 ...
 *
 */
class CompositionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_compositions_cours1_idx' => ['type' => 'index', 'columns' => ['cours_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_compositions_cours1' => ['type' => 'foreign', 'columns' => ['cours_id'], 'references' => ['cours', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
