 ...
 *
 */
class SeancesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'etat' => ['type' => 'string', 'length' => 10, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_seances_cours1_idx' => ['type' => 'index', 'columns' => ['cours_id'], 'length' => []],
            'fk_seances_salles1_idx' => ['type' => 'index', 'columns' => ['salle_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_seances_cours1' => ['type' => 'foreign', 'columns' => ['cours_id'], 'references' => ['cours', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_seances_salles1' => ['type' => 'foreign', 'columns' => ['salle_id'], 'references' => ['salles', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
