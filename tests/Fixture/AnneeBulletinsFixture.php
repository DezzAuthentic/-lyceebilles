...
/**
 * AnneeBulletinsFixture
 *
 */
class AnneeBulletinsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_annee_bulletins_affectations1_idx' => ['type' => 'index', 'columns' => ['affectation_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_annee_bulletins_affectations1' => ['type' => 'foreign', 'columns' => ['affectation_id'], 'references' => ['affectations', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
